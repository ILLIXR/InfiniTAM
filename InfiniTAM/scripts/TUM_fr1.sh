...
# TUM RGBD with list
../build/Apps/InfiniTAM/InfiniTAM ./calibration/TUM_fr1.txt ~/Documents/Datasets/TUM-RGBD/$seq/matched_groundtruth.txt ~/Documents/Datasets/TUM-RGBD/$seq/color_list.txt ~/Documents/Datasets/TUM-RGBD/$seq/depth_list.txt
